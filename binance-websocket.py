...
def main():
    ...
    def handle_socket_message(msg):
        ...
        mexc_ask_price = Decimal(global_redis_instance.get(name=f'{symbol}_ask_spot_mexc'))
    ...
    streams = ['movrusdt@aggTrade', 'highusdt@aggTrade', 'truusdt@aggTrade', 'btcusdt@aggTrade', 'ethusdt@aggTrade',
               'xrpusdt@aggTrade']
